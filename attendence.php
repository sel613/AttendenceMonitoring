                    ...
                    <div class="border border-2 px-4 py-2 mb-2">
                        ...
                        <form action="" method="post">
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="empid" value="<?php if (isset($_POST['empid'])) {
                                                                                                    echo $_POST['empid'];
                                                                                                } ?>" id="search" />
                                </div>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" name="fromdate" class="form-control" value="<?php if (isset($_POST['fromdate'])) {
                                                                                                        echo $_POST['fromdate'];
                                                                                                    } ?>" id="date" />
                                </div>
                                <label for="date" class=" col-sm-2 col-form-label">To Date</label>
                                <div class="col-sm-3">
                                    <input type="date" name="todate" value="<?php if (isset($_POST['todate'])) {
                                                                                echo $_POST['todate'];
